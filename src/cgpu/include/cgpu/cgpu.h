...
typedef void (*CGPUProcFreeQueryPool)(CGPUQueryPoolId pool);
...
CGPU_API void cgpu_free_query_pool(CGPUQueryPoolId pool);
...
CGPU_API void cgpu_free_swap_chain(CGPUSwapChainId swapchain);
