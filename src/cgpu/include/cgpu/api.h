...
CGPU_API void cgpu_free_fence(CGPUDeviceId _this, CGPUFenceId fence);
CGPU_API CGPUSemaphoreId cgpu_create_semaphore(CGPUDeviceId _this);
CGPU_API void cgpu_free_semaphore(CGPUDeviceId _this, CGPUSemaphoreId semaphore);
CGPU_API CGPUSemaphoreId cgpu_create_semaphore(CGPUDeviceId _this);
CGPU_API void cgpu_free_semaphore(CGPUDeviceId _this, CGPUSemaphoreId semaphore);
CGPU_API CGPUSemaphoreId cgpu_create_semaphore(CGPUDeviceId _this);
CGPU_API CGPURootSignaturePoolId cgpu_create_root_signature_pool(CGPUDeviceId _this, const CGPURootSignaturePoolDescriptor* desc);
CGPU_API void cgpu_free_root_signature_pool(CGPUDeviceId _this, CGPURootSignaturePoolId pool);
CGPU_API CGPURootSignatureId cgpu_create_root_signature(CGPUDeviceId _this, const CGPURootSignatureDescriptor* desc);
CGPU_API void cgpu_free_root_signature(CGPUDeviceId _this, CGPURootSignatureId signature);
CGPU_API CGPUDescriptorSetId cgpu_create_descriptor_set(CGPUDeviceId _this, const CGPUDescriptorSetDescriptor* desc);
CGPU_API void cgpu_free_descriptor_set(CGPUDeviceId _this, CGPUDescriptorSetId set);
CGPU_API CGPUComputePipelineId cgpu_create_compute_pipeline(CGPUDeviceId _this, const CGPUComputePipelineDescriptor* desc);
CGPU_API void cgpu_free_compute_pipeline(CGPUDeviceId _this, CGPUComputePipelineId pipeline);
CGPU_API CGPURenderPipelineId cgpu_create_render_pipeline(CGPUDeviceId _this, const CGPURenderPipelineDescriptor* desc);
CGPU_API void cgpu_free_render_pipeline(CGPUDeviceId _this, CGPURenderPipelineId pipeline);
CGPU_API CGPUQueryPoolId cgpu_create_query_pool(CGPUDeviceId _this, const CGPUQueryPoolDescriptor* desc);
CGPU_API void cgpu_free_query_pool(CGPUDeviceId _this, CGPUQueryPoolId pool);
CGPU_API CGPUMemoryPoolId cgpu_create_memory_pool(CGPUDeviceId _this, const CGPUMemoryPoolDescriptor* desc);
CGPU_API void cgpu_free_memory_pool(CGPUDeviceId _this, CGPUMemoryPoolId pool);
CGPU_API CGPUQueueId cgpu_get_queue(CGPUDeviceId _this, ECGPUQueueType type, uint32_t index);
CGPU_API void cgpu_free_queue(CGPUDeviceId _this, CGPUQueueId queue);
CGPU_API CGPURenderPassId cgpu_create_render_pass(CGPUDeviceId _this, const CGPURenderPassDescriptor* desc);
CGPU_API CGPUFramebufferId cgpu_create_framebuffer(CGPUDeviceId _this, const CGPUFramebufferDescriptor* desc);
CGPU_API void cgpu_free_render_pass(CGPUDeviceId _this, CGPURenderPassId render_pass);
CGPU_API void cgpu_free_framebuffer(CGPUDeviceId _this, CGPUFramebufferId framebuffer);
CGPU_API void cgpu_free_command_pool(CGPUDeviceId _this, CGPUCommandPoolId pool);
CGPU_API CGPUShaderLibraryId cgpu_create_shader_library(CGPUDeviceId _this, const CGPUShaderLibraryDescriptor* desc);
CGPU_API void cgpu_free_shader_library(CGPUDeviceId _this, CGPUShaderLibraryId library);
CGPU_API CGPUBufferId cgpu_create_buffer(CGPUDeviceId _this, const CGPUBufferDescriptor* desc);
CGPU_API void cgpu_free_buffer(CGPUDeviceId _this, CGPUBufferId buffer);
CGPU_API CGPUSamplerId cgpu_create_sampler(CGPUDeviceId _this, const CGPUSamplerDescriptor* desc);
CGPU_API void cgpu_free_sampler(CGPUDeviceId _this, CGPUSamplerId sampler);
CGPU_API CGPUTextureId cgpu_create_texture(CGPUDeviceId _this, const CGPUTextureDescriptor* desc);
CGPU_API void cgpu_free_texture(CGPUDeviceId _this, CGPUTextureId texture);
CGPU_API CGPUTextureViewId cgpu_create_texture_view(CGPUDeviceId _this, const CGPUTextureViewDescriptor* desc);
CGPU_API void cgpu_free_texture_view(CGPUDeviceId _this, CGPUTextureViewId render_target);
CGPU_API bool cgpu_try_bind_aliasing_texture(CGPUDeviceId _this, const CGPUTextureAliasingBindDescriptor* desc);
CGPU_API uint64_t cgpu_export_shared_texture_handle(CGPUDeviceId _this, const CGPUExportTextureDescriptor* desc);
CGPU_API CGPUTextureId cgpu_import_shared_texture_handle(CGPUDeviceId _this, const CGPUImportTextureDescriptor* desc);
CGPU_API CGPUSwapChainId cgpu_create_swap_chain(CGPUDeviceId _this, const CGPUSwapChainDescriptor* desc);
CGPU_API void cgpu_free_swap_chain(CGPUDeviceId _this, CGPUSwapChainId swapchain);
CGPU_API CGPUSurfaceId cgpu_create_surface_from_native_view(CGPUDeviceId _this, void* view);
CGPU_API CGPUSurfaceId cgpu_create_surface_from_hwnd(CGPUDeviceId _this, HWND window);
CGPU_API CGPUSurfaceId cgpu_create_surface_from_native_window(CGPUDeviceId _this, ANativeWindow* window);
CGPU_API void cgpu_free_surface(CGPUDeviceId _this, CGPUSurfaceId surface);
CGPU_API void cgpu_wait_fences(const CGPUFenceId* fences, uint32_t fence);
CGPU_API ECGPUFenceStatus cgpu_query_fence_status(CGPUFenceId _this);
CGPU_API void cgpu_submit_queue(CGPUQueueId _this, const CGPUQueueSubmitDescriptor* desc);
CGPU_API void cgpu_queue_present(CGPUQueueId _this, const CGPUQueuePresentDescriptor* desc);
CGPU_API void cgpu_wait_queue_idle(CGPUQueueId _this);
...
CGPU_API CGPUCommandPoolId cgpu_create_command_pool(CGPUQueueId _this, const CGPUCommandPoolDescriptor* desc);
CGPU_API void cgpu_update(CGPUDescriptorSetId _this, const CGPUDescriptorData* datas, uint32_t count);
CGPU_API CGPUCommandBufferId cgpu_create_command_buffer(CGPUCommandPoolId _this, const CGPUCommandBufferDescriptor* desc);
CGPU_API void cgpu_reset(CGPUCommandPoolId _this);
CGPU_API void cgpu_free_command_buffer(CGPUCommandPoolId _this, CGPUCommandBufferId cmd);
CGPU_API void cgpu_map(CGPUBufferId _this, const CGPUBufferRange* range);
CGPU_API void cgpu_unmap(CGPUBufferId _this);
CGPU_API uint32_t cgpu_acquire_next_image(CGPUSwapChainId _this, const CGPUAcquireNextDescriptor* desc);
CGPU_API void cgpu_begin(CGPUCommandBufferId _this);
CGPU_API void cgpu_transfer_buffer_to_buffer(CGPUCommandBufferId _this, const CGPUBufferToBufferTransfer* desc);
CGPU_API void cgpu_transfer_texture_to_texture(CGPUCommandBufferId _this, const CGPUTextureToTextureTransfer* desc);
CGPU_API void cgpu_transfer_buffer_to_texture(CGPUCommandBufferId _this, const CGPUBufferToTextureTransfer* desc);
CGPU_API void cgpu_transfer_buffer_to_tiles(CGPUCommandBufferId _this, const CGPUBufferToTilesTransfer* desc);
CGPU_API void cgpu_resource_barrier(CGPUCommandBufferId _this, const CGPUResourceBarrierDescriptor* desc);
CGPU_API void cgpu_begin_query(CGPUCommandBufferId _this, CGPUQueryPoolId pool, const CGPUQueryDescriptor* desc);
CGPU_API void cgpu_end_query(CGPUCommandBufferId _this, CGPUQueryPoolId pool, const CGPUQueryDescriptor* desc);
CGPU_API void cgpu_reset_query_pool(CGPUCommandBufferId _this, CGPUQueryPoolId pool, uint32_t start_query, uint32_t query_count);
CGPU_API void cgpu_resolve_query(CGPUCommandBufferId _this, CGPUQueryPoolId pool, CGPUBufferId readback, uint32_t start_query, uint32_t query_count);
CGPU_API void cgpu_end(CGPUCommandBufferId _this);
CGPU_API CGPUComputePassEncoderId cgpu_begin_compute_pass(CGPUCommandBufferId _this, const CGPUComputePassDescriptor* desc);
CGPU_API void cgpu_compute_encoder_bind_descriptor_set(CGPUComputePassEncoderId encoder, CGPUDescriptorSetId set);
CGPU_API void cgpu_compute_encoder_bind_compute_pipeline(CGPUComputePassEncoderId encoder, CGPUComputePipelineId pipeline);
CGPU_API void cgpu_compute_encoder_dispatch(CGPUComputePassEncoderId encoder, uint32_t x, uint32_t y, uint32_t z);
CGPU_API void cgpu_end_compute_pass(CGPUCommandBufferId _this, CGPUComputePassEncoderId encoder);
CGPU_API CGPURenderPassEncoderId cgpu_begin_render_pass(CGPUCommandBufferId _this, const CGPUBeginRenderPassInfo* begin_info);
CGPU_API void cgpu_set_shading_rate(CGPURenderPassEncoderId _this, ECGPUShadingRate shading_rate, ECGPUShadingRateCombiner post_rasterize_rate, ECGPUShadingRateCombiner final_rate);
CGPU_API void cgpu_bind_descriptor_set(CGPURenderPassEncoderId _this, CGPUDescriptorSetId set);
CGPU_API void cgpu_set_viewport(CGPURenderPassEncoderId _this, float x, float y, float width, float height, float min_depth, float max_depth);
CGPU_API void cgpu_set_scissor(CGPURenderPassEncoderId _this, uint32_t x, uint32_t y, uint32_t width, uint32_t height);
CGPU_API void cgpu_bind_render_pipeline(CGPURenderPassEncoderId _this, CGPURenderPipelineId pipeline);
CGPU_API void cgpu_bind_vertex_buffers(CGPURenderPassEncoderId _this, uint32_t buffer_count, const CGPUBufferId* buffers, const uint32_t* strides, const uint32_t* offsets);
CGPU_API void cgpu_bind_index_buffer(CGPURenderPassEncoderId _this, CGPUBufferId buffer, uint32_t index_stride, uint64_t offset);
CGPU_API void cgpu_push_constants(CGPURenderPassEncoderId _this, CGPURootSignatureId rs, const char* name, const void* data);
CGPU_API void cgpu_compute_encoder_push_constants(CGPUComputePassEncoderId encoder, CGPURootSignatureId rs, const char* name, const void* data);
CGPU_API void cgpu_draw(CGPURenderPassEncoderId _this, uint32_t vertex_count, uint32_t first_vertex);
CGPU_API void cgpu_draw_instanced(CGPURenderPassEncoderId _this, uint32_t vertex_count, uint32_t first_vertex, uint32_t instance_count, uint32_t first_instance);
CGPU_API void cgpu_draw_indexed(CGPURenderPassEncoderId _this, uint32_t index_count, uint32_t first_index, uint32_t first_vertex);
CGPU_API void cgpu_draw_indexed_instanced(CGPURenderPassEncoderId _this, uint32_t index_count, uint32_t first_index, uint32_t instance_count, uint32_t first_instance, uint32_t first_vertex);
CGPU_API void cgpu_end_render_pass(CGPUCommandBufferId _this, CGPURenderPassEncoderId encoder);
CGPU_API void cgpu_begin_event(CGPUCommandBufferId _this, const CGPUEventInfo* event);
CGPU_API void cgpu_set_marker(CGPUCommandBufferId _this, const CGPUMarkerInfo* marker);
CGPU_API void cgpu_end_event(CGPUCommandBufferId _this);
CGPU_API CGPULinkedShaderId cgpu_compile_and_link_shaders(CGPURootSignatureId signature, const CGPUCompiledShaderDescriptor* desc, uint32_t count);
CGPU_API void cgpu_compile_shaders(CGPURootSignatureId signature, const CGPUCompiledShaderDescriptor* desc, uint32_t count, CGPUCompiledShaderId* out_isas);
...
CGPU_API CGPUStateBufferId cgpu_create_state_buffer(CGPUCommandBufferId cmd, const CGPUStateBufferDescriptor* desc);
CGPU_API void cgpu_bind_state_buffer(CGPURenderPassEncoderId _this, CGPUStateBufferId stream);
...
CGPU_API void cgpu_raster_state_encoder_set_viewport(CGPURasterStateEncoderId encoder, float x, float y, float width, float height, float min_depth, float max_depth);
CGPU_API void cgpu_raster_state_encoder_set_scissor(CGPURasterStateEncoderId encoder, uint32_t x, uint32_t y, uint32_t width, uint32_t height);
CGPU_API void cgpu_raster_state_encoder_set_cull_mode(CGPURasterStateEncoderId encoder, ECGPUCullModeFlags cull_mode);
CGPU_API void cgpu_raster_state_encoder_set_front_face(CGPURasterStateEncoderId encoder, ECGPUFrontFace front_face);
CGPU_API void cgpu_raster_state_encoder_set_primitive_topology(CGPURasterStateEncoderId encoder, ECGPUPrimitiveTopology topology);
CGPU_API void cgpu_raster_state_encoder_set_depth_test_enabled(CGPURasterStateEncoderId encoder, bool enabled);
CGPU_API void cgpu_raster_state_encoder_set_depth_write_enabled(CGPURasterStateEncoderId encoder, bool enabled);
CGPU_API void cgpu_raster_state_encoder_set_depth_compare_op(CGPURasterStateEncoderId encoder, ECGPUCompareOp compare_op);
CGPU_API void cgpu_raster_state_encoder_set_stencil_test_enabled(CGPURasterStateEncoderId encoder, bool enabled);
CGPU_API void cgpu_raster_state_encoder_set_stencil_compare_op(CGPURasterStateEncoderId encoder, ECGPUStencilFaceFlags faces, ECGPUStencilOp fail_op, ECGPUStencilOp pass_op, ECGPUStencilOp depth_fail_op, ECGPUCompareOp compare_op);
CGPU_API void cgpu_raster_state_encoder_set_fill_mode(CGPURasterStateEncoderId encoder, ECGPUFillMode fill_mode);
CGPU_API void cgpu_raster_state_encoder_set_sample_count(CGPURasterStateEncoderId encoder, ECGPUSampleCountFlags sample_count);
...
CGPU_API void cgpu_shader_state_encoder_bind_shaders(CGPUShaderStateEncoderId encoder, uint32_t stage_count, const ECGPUShaderStageFlags* stages, const CGPUCompiledShaderId* shaders);
CGPU_API void cgpu_shader_state_encoder_bind_linked_shader(CGPUShaderStateEncoderId encoder, CGPULinkedShaderId linked);
