...
void VkUtil_InitializeShaderReflection(cgpu_device_id device, CGPUShaderLibrary_Vulkan* library, const struct CGPUShaderLibraryDescriptor* desc);
...
CGPU_UNUSED static const char* validation_layer_name = "VK_LAYER_KHRONOS_validation";
CGPU_UNUSED static const char* cgpu_wanted_instance_exts[] = {
...
CGPU_UNUSED static const char* cgpu_wanted_device_exts[] = {
