...
extern "C" {
#endif
CGPU_UNUSED static const VkCullModeFlagBits gVkCullModeTranslator[CGPU_CULL_MODE_COUNT] = {
    VK_CULL_MODE_NONE,
    VK_CULL_MODE_BACK_BIT,
    VK_CULL_MODE_FRONT_BIT
};

CGPU_UNUSED static const VkPolygonMode gVkFillModeTranslator[CGPU_FILL_MODE_COUNT] = {
    VK_POLYGON_MODE_FILL,
    VK_POLYGON_MODE_LINE
};

CGPU_UNUSED static const VkFrontFace gVkFrontFaceTranslator[] = {
...
// API Helpers
CGPU_FORCEINLINE static void VkUtil_GetVertexInputBindingAttrCount(const CGPUVertexLayout* pLayout, uint32_t* pBindingCount, uint32_t* pAttrCount)
{
...
CGPU_FORCEINLINE static VkImageAspectFlags VkUtil_DeterminAspectMask(VkFormat format, bool includeStencilBit)
{
...
CGPU_FORCEINLINE static VkDebugReportObjectTypeEXT VkUtil_ObjectTypeToDebugReportType(VkObjectType type)
{
    switch (type)
    {
