...
struct ImGui_ImplCGPU_Window
{
    ...
    cgpu_texture_format_enum         SurfaceFormat;
...
static void CreateOrResizeBuffer(CGPUBufferId& buffer, size_t& p_buffer_size, size_t new_size, cgpu_resource_type_flag resourceType, cgpu_resource_state_flag state)
{
...
static void ImGui_ImplCGPU_RenderWindow(ImGuiViewport* viewport, void*)
{
    ...
    cgpu_render_encoder_set_shading_rate(rp_encoder, cgpu_shading_rate_enum::CGPU_SHADING_RATE_FULL, cgpu_shading_rate_combiner_enum::CGPU_SHADING_RATE_COMBINER_PASS_THROUGH, cgpu_shading_rate_combiner_enum::CGPU_SHADING_RATE_COMBINER_PASS_THROUGH);
