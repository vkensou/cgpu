/* clang-format off */
CGPU_FORCEINLINE static VkSampleCountFlagBits VkUtil_SampleCountTranslateToVk(const ECGPUSampleCount count)
{
...
CGPU_FORCEINLINE static VkFormat VkUtil_FormatTranslateToVk(const ECGPUFormat fmt)
{
switch (fmt) {
...
CGPU_FORCEINLINE static ECGPUFormat VkUtil_FormatTranslateToCGPU(const VkFormat fmt)
{
switch (fmt) {
