...
.\tools\slang\slangc shaders\imgui.hlsl -profile sm_5_0 -capability SPIRV_1_3 -entry vert -o shaders\imgui.vert.spv -O3 -emit-spirv-directly
.\tools\slang\slangc shaders\imgui.hlsl -profile sm_5_0 -capability SPIRV_1_3 -entry frag -o shaders\imgui.frag.spv -O3 -emit-spirv-directly
